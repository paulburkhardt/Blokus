...
/**
 * Controller for juniorGameView.
 *
 * @author lfiebig
 */
public class JuniorGameViewController {

  @FXML
  public Group fourSquaresPieceTwo;
  @FXML
  public Group oneSquarePieceOne;
  @FXML
  ...
  // position of the mousecursor on the gameboar
  ...
  private BlokusJuniorGame gameSession;
   ...
   */
  public void setInfo(BlokusJuniorGame gameSession, Player player, GameTheme theme) {
  ...
  public void showViableSpaces() {
    ...
    for (BoardSpace bc : player.getViableSpaces()) {
      gridPaneArray[bc.getPosition().getXcoord()][bc.getPosition().getYcoord()].setId(
          "viableSpace");
      gridPaneArray[bc.getPosition().getXcoord()][bc.getPosition().getYcoord()].setStyle(
          "-fx-border-width: 2; -fx-border-color: red");
    }
  }
