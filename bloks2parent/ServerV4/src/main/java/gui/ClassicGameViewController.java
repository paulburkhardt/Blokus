...
/**
 * Controller for classicGameView.
 *
 * @author lfiebig
 */
public class ClassicGameViewController {
  ...
  @FXML public Text scorePlayerThree;
  @FXML public Text scorePlayerFour;
  ...
  private ClassicBlokusGame gameSession;
  ...
  public void initializeGridPaneArray() {
    this.gridPaneArray = new Node[20][20];
   ...
   */
  public void setInfo(ClassicBlokusGame gameSession, Player player, GameTheme theme) {
   ...
   */
  public void onLeaveGame() throws IOException {
    try {
  ...
  /** Updates the view of the Board to the current gamestate. */
            ...
            for (int j = 0; j < 20; j++) {
              switch (this.gameSession.getBoard().getBoardSpaces()[i][j].getIsCoveredByWhom()) {
                ...
                case 3:
                  ...
                  gridPaneArray[i][j].setStyle(
                      "-fx-background-color: "
                          + this.player.getBoardTheme().getColors()[2]
                          + "; -fx-border-width: 1.5; -fx-border-color: white");
                  gridPaneArray[i][j].setId("coveredSpace");
                  break;
                case 4:
                  ...
                  gridPaneArray[i][j].setStyle(
                      "-fx-background-color: "
                          + this.player.getBoardTheme().getColors()[3]
                          + "; -fx-border-width: 1.5; -fx-border-color: white");
                  gridPaneArray[i][j].setId("coveredSpace");
                  break;
                default:
